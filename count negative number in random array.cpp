...
int negativenumberscount(int arr1[100], int num)
{
	int count = 0;
	for (int b = 0; b < num; b++)
	{
...
void printnegativenumberscount(int x)
{
	cout << "negative number count is " << x << endl;
}
int main()
{
	...
	printnegativenumberscount(negativenumberscount(j, r));
